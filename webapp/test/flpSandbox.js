		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Start Purchase Order Request",
									"targetURL": "#gbwfcerpurchaseinitcerpurchaseinit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gbwfcerpurchaseinitcerpurchaseinit-display": {
								"semanticObject": "gbwfcerpurchaseinitcerpurchaseinit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gb.wf.cer.purchase.init.cerpurchaseinit",
									"url": sap.ui.require.toUrl("gb/wf/cer/purchase/init/cerpurchaseinit")
								}
							}
						}
					}
